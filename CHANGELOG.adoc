...
CAUTION: Search: The  `/api/v1/search/reindex` endpoint was replaced by `/api/v1/search/indexSync`.

icon:plus[] The `/api/v1/search/indexSync` endpoint can now be used to trigger the differential synchronization of search indices. 
